...
def main():
    ...
    parser.add_argument('--tracker_name', type=str, default='entertrack', help='Name of tracking method.')
    parser.add_argument('--tracker_param', type=str, default='entertrack_threemdot_lasot_ft_cons',help='Name of config file.')
    parser.add_argument('--runid', type=int, default=14, help='The run id.')
