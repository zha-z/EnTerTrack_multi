...
def main():
    ...
    parser.add_argument('--script', type=str, default='entertrack',help='Name of the train script.')
    parser.add_argument('--config', type=str, default='entertrack_threemdot',help="Name of the config file.")
    parser.add_argument('--cudnn_benchmark', type=bool, default=True, help='Set cudnn benchmark on (1) or off (0) (default is on).')
    parser.add_argument('--local-rank', default=-1, type=int, help='node rank for distributed training')
    parser.add_argument('--save_dir', type=str, default="/data/zjy/multi/output/entertrack/test",help='the directory to save checkpoints and logs')
