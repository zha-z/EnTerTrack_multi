...
DatasetInfo = namedtuple('DatasetInfo', ['module', 'class_name', 'kwargs']) #创建一个具名元组，类名为‘DatasetInfo’，各个字段名分别为‘module’ ‘class_name’ 'kwargs'
...
def load_dataset(name: str):
    ...
    name = name.lower() #转换为小写名称
    dset_info = dataset_dict.get(name) #在字典中查找
