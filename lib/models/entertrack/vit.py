...
from lib.models.entertrack.base_backbone import BaseBackbone
...
class VisionTransformer(BaseBackbone):
    ...
    def init_weights(self, mode=''):
        ...
        trunc_normal_(self.pos_embed, std=.02) #标准差为0.02的截断正态分布进行位置编码
...
def vit_tiny_patch16_224(pretrained=False, **kwargs):
    ...
    return model
def vit_tiny_patch16_224_half(pretrained=False, **kwargs):
    """ ViT-Base model (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    """
    model_kwargs = dict(
